#
# $Id: JP.pod,v 2.0 2003/05/22 18:19:11 dankogai Exp dankogai $
#
=head1 NAME
...
を提供します。kakasiが提供するのは、input methodと逆の機能、すなわちか
な漢字まじり文をひらがな、カタカナ、ローマ字などに逆変換します。kakasi
...
が、Perl 5.8以降の新機能を使うにはオブジェクト指向インターフェイスを
使う必要があります。 
